        ...
        <>
                ...
                <div className="footer__menu">
                    <div className="footer__box">
                        <div className="footer__contact">
                            ...
                            <span className="footer__contact-link">г. Москва, Нижний проезд, 25/3</span>
                        </div>
                        <div className="footer__contact">
                            <span className="footer__name">Контакты:</span>
                            <a className="footer__contact-link" href="mailto:infobriaton@group.ru">infobriaton@group.ru</a>
                            <a className="footer__contact-link" href="tel:+78002220037">+7 (800) 222-00-37</a>
                        </div>
                    </div>
                    <div className="footer__social">
                        ...
                        <ul className="footer__social-list">
                            <li className="footer__social-item">
                                <a className="footer__social-link" href="#">Дзен</a>
                            </li>
                            <li className="footer__social-item">
                                <a className="footer__social-link" href="#">Одноклассники</a>
                            </li>
                            <li className="footer__social-item">
                                <a className="footer__social-link" href="#">Pinterest</a>
                            </li>
                            <li className="footer__social-item">
            ...
            <div id="partner" className="footer__bottom" >
                <div className="footer__policy">
                    <a className="footer__policy-link" href="#">Политика обработки персональных данных</a>
                    <a className="footer__policy-link" href="#">Политика конфиденциальности</a>
                </div>
