import { storeOption } from "../../../api/filtersStore";
import { SORT_OPTIONS, useProductFilterStore } from "../../../hooks/useProductFilterStore";
            ...
            <div className="catalog__products">
                <div className="catalog__sort">
                    ...
                    <select
                        ...
                        value={sort}
                        name="sort"
                        onChange={((e) => setSortOption(e.target.value as typeof SORT_OPTIONS[keyof typeof SORT_OPTIONS]))}
                    >
