            ...
            <ul className="catalog-form__list-col">
                <li className="catalog-form__item-col">
                    <div className="custom-checkbox custom-checkbox--pendant">
                        <input className="visually-hidden custom-checkbox__field" id="pendant" type="checkbox" value="pendant" name="type"></input>
                        <label className="custom-checkbox__label" htmlFor="pendant">
                            <span className="custom-checkbox__name">
                                Подвесные
                            </span>
                            <IconCheck className="custom-checkbox__icon" width="10" height="10" aria-hidden="true" />
                        </label>
                    </div>
                </li>
                <li className="catalog-form__item-col">
                    <div className="custom-checkbox custom-checkbox--ceiling">
                        <input className="visually-hidden custom-checkbox__field" id="ceiling" type="checkbox" name="type" value="ceiling"></input>
                ...
                <li className="catalog-form__item-col">
                    <div className="custom-checkbox custom-checkbox--overhead">
                        <input className="visually-hidden custom-checkbox__field" id="overhead" type="checkbox" name="type" value="overhead"></input>
                ...
                <li className="catalog-form__item-col">
                    <div className="custom-checkbox custom-checkbox--point">
                        <input className="visually-hidden custom-checkbox__field" id="point" type="checkbox" name="type" value="point"></input>
                ...
                <li className="catalog-form__item-col">
                    <div className="custom-checkbox custom-checkbox--nightlights">
                        <input className="visually-hidden custom-checkbox__field" id="nightlights" type="checkbox" name="type" value="nightlights"></input>
...
export default FieldsetSortProduct;
