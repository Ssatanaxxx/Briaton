    ...
    <div className="container">
      <div className="mainPage">
        ...
        <p className="main-page__intro-text">
          Мы — команда энтузиастов, которые верят, что правильное освещение
          может преобразить любое пространство. С 2015 года мы помогаем нашим
          клиентам создавать атмосферу тепла, комфорта и стиля в их домах,
          офисах и общественных помещениях.
        </p>
        ...
        <span className="main-page__mission-quote">
          💡 «Briaton» — освещаем вашу жизнь с 2015 года.
        </span>
      </div>
    </div>
  );
